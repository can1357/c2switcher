...
from ..constants import C2SWITCHER_DIR, console
...
class SessionService:
   ...
   def __init__(self, store: Store):
      self.store = store
      self.cleanup_marker = C2SWITCHER_DIR / ".last_cleanup"

   def register(
      self, session_id: str, pid: int, parent_pid: Optional[int], cwd: str
   ) -> Session:
      """
