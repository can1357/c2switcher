...
@click.option("--output", "-o", type=click.Path(), help="Output path (default: ~/.claude/.credentials.json)")
@click.option("--no-browser", is_flag=True, help="Don't auto-open browser")
@click.option("--manual-only", is_flag=True, help="Use manual code paste (disable automatic localhost callback)")
...
def login(output: Optional[str], no_browser: bool, manual_only: bool, no_add: bool, nickname: Optional[str]):
