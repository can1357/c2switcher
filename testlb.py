...
def algo_baseline(accounts: List[AccountSnapshot]) -> Tuple[AccountSnapshot, float, dict]:
   ...
   for acc in accounts:
      ...
      if score > best_score:
         ...
         best_debug = {'drain': drain, 'pace': pace_adj, 'fresh': fresh_bonus, 'util': util, 'hrs': hrs}
...
def algo_low_usage_bonus(accounts: List[AccountSnapshot]) -> Tuple[AccountSnapshot, float, dict]:
   ...
   for acc in accounts:
      ...
      if score > best_score:
         best, best_score = acc, score
         best_debug = {'drain': drain, 'pace': pace_adj, 'low_bonus': low_bonus, 'util': util, 'hrs': hrs}

   return best, best_score, best_debug


def algo_simple_lowest(accounts: List[AccountSnapshot]) -> Tuple[AccountSnapshot, float, dict]:
...
def algo_combined(accounts: List[AccountSnapshot]) -> Tuple[AccountSnapshot, float, dict]:
   ...
   for acc in accounts:
      ...
      if score > best_score:
         best, best_score = acc, score
         best_debug = {'drain': drain, 'pace': pace_adj, 'low_bonus': low_bonus, 'util': util, 'window': window, 'hrs': hrs}
...
def algo_overall_first(accounts: List[AccountSnapshot]) -> Tuple[AccountSnapshot, float, dict]:
   ...
   for acc in accounts:
      ...
      if score > best_score:
         best, best_score = acc, score
         best_debug = {'headroom': headroom, 'hrs': hrs, 'util': util, 'window': window}

   return best, best_score, best_debug


def algo_headroom_per_hour(accounts: List[AccountSnapshot]) -> Tuple[AccountSnapshot, float, dict]:
